BootstrapPrototyping::Application.routes.draw do
  ...
  match 'candidate_profile_social_share' => 'shareable#candidate_profile_social_share'
  match 'candidate_profile_email_share'  => 'shareable#candidate_profile_email_share'
